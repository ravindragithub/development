trigger DB_Custom_myKVH_Shared_Platforms_c on myKVH_Shared_Platforms__c ( before delete, after insert, after update, after undelete )
{
	try
	{
	...
	{
		CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_myKVH_Shared_Platforms_c' );
	}
}