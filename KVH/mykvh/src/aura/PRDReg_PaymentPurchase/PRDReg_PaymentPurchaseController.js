({
    doInit: function(component, event, helper) {    
        if(typeof component.get("v.simpleLTEActivation.Id") != 'undefined'){
            helper.callAttachmentList(component, null, null);
        }
        helper.getPopList(component);
    ...
    handleUploadFinished: function (component, event,helper) {
        ...
        helper.callAttachmentList(component, documentId, documentName);
    ...
    payPurchaseValidation : function(component, event, helper) {
        helper.payPurchaseValHelper(component, event, helper);           
    },
})